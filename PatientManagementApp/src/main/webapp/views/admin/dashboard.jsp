        ...
        <div class="row">
            ...
            <div class="col-md-9 col-lg-10 main-content">
                ...
                <div class="quick-actions">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <a href="${pageContext.request.contextPath}/admin/ajouter-medecin" class="btn action-button w-100">
                                <i class="fas fa-user-plus me-2"></i>Ajouter un médecin
                            </a>
                        </div>
                        <div class="col-md-3">
                            <a href="${pageContext.request.contextPath}/admin/ajouter-patient" class="btn action-button w-100">
                                <i class="fas fa-user-plus me-2"></i>Ajouter un patient
                            </a>
                        </div>
                        <div class="col-md-3">
                            <a href="${pageContext.request.contextPath}/admin/rendez-vous" class="btn action-button w-100">
                                <i class="fas fa-calendar-plus me-2"></i>Gérer les rendez-vous
                            </a>
                        </div>
                    </div>
                </div>
