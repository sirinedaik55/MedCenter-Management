    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-9 col-lg-10 main-content">
                <div class="form-card">
                    <h2 class="form-title">Ajouter un Patient</h2>
                    ...
                    <form action="${pageContext.request.contextPath}/admin/ajouter-patient" method="post">
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="numeroSecuriteSociale" name="numeroSecuriteSociale" 
                                       pattern="[0-9]{15}" title="Le numéro doit contenir 15 chiffres" required>
                            </div>
                        </div>
